...
function AdvanceOrders() {
  ...
  const generateA4PDF = async () => {
    try {
      ...
      try { if (a.c.tLogo) { pdf.addImage(a.c.tLogo, 'PNG', margin, 2, 22, 22); logoLoaded = true; } } catch (_) {}
      ...
      pdf.text('A.C.T Services — Advance Order Statement', pageW / 2, pageH - 6, { align: 'center' });
      return pdf;
