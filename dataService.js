...
class DataService {
  ...
  // Uses the same localforage key ('a.c.t_users') as the Admin app so that
  ...
  async getUsers() {
    ...
    return await localforage.getItem('a.c.t_users') || [];
  }

  // ── Landlord — reads from the same 'a.c.t_users' forage key ────────────
